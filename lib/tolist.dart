...
import 'package:statemanag_app/handleMessages.dart';
import 'package:statemanag_app/nextPage.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (_) => const HomeHome()));
          },
        ),
      ),
      body: snapshot.when(
        data: (data) {
          List<String> todoLists =
              data.docs.map((e) => e.get('todos').toString()).toList();
          return Container(
